        ...
        <footer aria-label="Site Footer" className="bg-white dark:bg-black">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-md">
                    ...
                    >
                        Want us to email you with the latest Roadster news?
                    </strong>
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">Our experienced Traffic Safety Officers will guide you through structured lessons, helping you develop a solid foundation in your drivers Journey.</p>
                    ...
                    >
                        <div>
                            <strong className="font-bold dark:text-white text-gray-900"> Products </strong>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    <p className="text-center text-xs/relaxed text-gray-500">
                        © tscz 2024. All rights reserved.

                        <br />

                        Created with &nbsp;
                        <a className="text-secondary dark: underline transition hover:text-secondary dark:/75">TSCZ_LEARN</a>
                    </p>
                </div>
            </div>
        </footer>
